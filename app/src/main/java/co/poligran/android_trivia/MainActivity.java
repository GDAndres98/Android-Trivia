...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        startButton .setBackgroundColor(Color.parseColor("#A3FF26"));
        startButton .setTextColor(Color.parseColor("#212121"));
